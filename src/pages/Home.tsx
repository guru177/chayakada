        ...
        <div className="wrap story-grid">
          <div className="polaroid">
            ...
            <div className="polaroid-print">
              <Pic src="/images/shop-vintage.jpg" alt="പഴയ കേരള ചായക്കട, vintage Kerala tea shop" width={800} height={1200} sizes="(max-width: 560px) 220px, (max-width: 1100px) 320px, 28vw" />
            </div>
          </div>
          <div className="story-copy" lang="ml">
            <div className="eyebrow">ചായയുടെ ചരിത്രം</div>
            <div className="story-rule" aria-hidden />
            <h2>കേരളത്തിലെ ചായയുടെ പാരമ്പര്യം</h2>
            <p>
              കേരളത്തിന്റെ മലയോരങ്ങളിൽ — മൂന്നാർ, വയനാട്, പീരുമേട് — പത്തൊൻപതാം നൂറ്റാണ്ടിന്റെ
              അവസാനം ബ്രിട്ടീഷ് കാലത്താണ് തേയിലത്തോട്ടങ്ങൾ വേരുറച്ചത്. കാപ്പിക്ക് പകരം തേയില വന്നു;
              മലനിരകൾ ഒരു പുതിയ സമ്പദ്‌വ്യവസ്ഥയായി മാറി. പക്ഷേ മലയാളിയുടെ ചായ തോട്ടത്തിലെ
              ബംഗ്ലാവിലല്ല ജീവിക്കുന്നത്. അത് ബസ് സ്റ്റാന്റിനരികെ, ചന്തയ്ക്കരികെ, മരപ്പലകയിട്ട
              കടമുറിയിലാണ്.
            </p>
            <p>
            ...
            <p>
              കേരളത്തിലെ ചായക്കട ഒരൊറ്റ കടയല്ല; ഒരു ജനാധിപത്യ സ്ഥലമാണ്. തൊഴിലാളി, വിദ്യാർത്ഥി,
              യാത്രക്കാരൻ — ആർക്കും ഒരു ഗ്ലാസ്. പദവിയില്ല, ഒരു ബെഞ്ച്, ഒരു കെറ്റിൽ, ഒരു ഗ്ലാസ്.
              ഇല, തിളച്ച വെള്ളം, സമയം — അതാണ് കട്ടന്റെ പാചകക്കുറിപ്പ്. അവിടെ നിൽക്കുമ്പോൾ സമയം
              പതുക്കെ നീങ്ങുന്നു — ചായ പോലെ.
            </p>
            <p>
              പണ്ട് ചായക്കടകളിൽ റേഡിയോ മാത്രമായിരുന്നു സംഗീതം. സന്ധ്യയായാൽ പഴയ ഗാനങ്ങൾ, വാർത്ത,
              കായിക വിവരണം. മേശപ്പുറത്ത് ബൺ, പഴംപൊരി, ഒരു ഗ്ലാസ് കട്ടൻ. മഴ പെയ്താൽ കട നിറയും;
              ആരും തിടുക്കപ്പെടില്ല. ചായ തണുത്താൽ വീണ്ടും ഒഴിച്ചുതരും — അതാണ് കേരളത്തിലെ
              ചായക്കടകളുടെ പഴയ നിയമം.
            </p>
            <p>
            ...
            <p>
              ...
              ആശ്വാസം വലുത്. അതുകൊണ്ടാണ് തലമുറകളായി കെറ്റിൽ അടുപ്പിൽ നിന്ന് ഇറങ്ങാത്തത്.
            </p>
            <p>
              കേരളത്തിലെ ചായയുടെ കഥ ഒരു കടയുടെ കഥയല്ല. അത് കാത്തിരിപ്പിന്റെ കഥയാണ് — ബസിനായി,
              മഴമാറ്റത്തിനായി, ഒരു വാക്കിനായി. ഇവിടെ ഇരുന്നാൽ നിങ്ങൾക്ക് ആ ഓർമ്മകൾ ഇപ്പോഴും
